...
// 3 - A função myRemoveWithoutCopy(arr, item) recebe um array arr e retorna o próprio array sem o elemento item 
// caso ele exista no array

assert.ok(typeof myRemoveWithoutCopy === 'function');
